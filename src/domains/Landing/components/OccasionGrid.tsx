              ...
              >
                <Card
                  className={cn(
                    ...
                    enabled
                      ? "hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/20 cursor-pointer"
                      : "opacity-95"
                  )}
                >
                  <CardContent className="p-0 relative isolate">
                    {/* click anywhere (only for enabled occasions) */}
                    {enabled && (
                      <Link to={`/${occasion.id}`} className="absolute inset-0 z-10" />
                    )}
