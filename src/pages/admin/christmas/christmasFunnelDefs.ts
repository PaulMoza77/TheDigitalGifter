...
export const CHRISTMAS_FUNNELS: ChristmasFunnelDef[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { event: "planner_cta_clicked", label: "Started" },
      { event: "planner_personalization_completed", label: "Personalization" },
      { event: "planner_preview_viewed", label: "Preview" },
      { event: "planner_paywall_viewed", label: "Paywall" },
      { event: "planner_package_selected", label: "Package" },
      { event: "planner_checkout_started", label: "Checkout" },
      { event: "planner_purchase", label: "Purchase" },
      { event: "planner_opened", label: "Planner opened" },
      { event: "planner_module_opened", label: "Module activation" },
      { event: "affiliate_product_clicked", label: "Affiliate click" },
    ],
