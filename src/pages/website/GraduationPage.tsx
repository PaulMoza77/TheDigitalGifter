// ✅ 1) Create: src/pages/website/GraduationPage.tsx
...
export default function GraduationPage() {
  ...
  // ✅ force occasion=graduation (keep other params)
  next.set("occasion", "graduation");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create a Proud <span className="text-orange-300">Graduation</span>
              <br />
              Card with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Minimal Cap & Gown", desc: "Clean layout, premium typography." },
              { title: "Bold Achievement Frame", desc: "Strong headline + modern borders." },
              { title: "Photo Collage Diploma", desc: "Gallery-style layout for memories." },
            ].map((t) => (
              <div
                key={t.title}
