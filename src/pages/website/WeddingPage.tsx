// ✅ 1) Create: src/pages/website/WeddingPage.tsx
...
export default function WeddingPage() {
  ...
  // ✅ force occasion=wedding (keep other params)
  next.set("occasion", "wedding");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create a Stunning <span className="text-orange-300">Wedding</span>
              <br />
              Card with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Minimal Save the Date", desc: "Clean typography + premium spacing." },
              { title: "Elegant Floral Frame", desc: "Soft florals with luxury feel." },
              { title: "Modern Photo Thank You", desc: "Gallery-style layout, timeless." },
            ].map((t) => (
              <div
                key={t.title}
