// ✅ 1) Create: src/pages/website/ThanksgivingPage.tsx
...
export default function ThanksgivingPage() {
  ...
  // ✅ keep existing params but force occasion=thanksgiving
  next.set("occasion", "thanksgiving");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/80">
              🦃 Thanksgiving — Gratitude Season
            </div>

            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create Heartfelt <span className="text-orange-300">Thanksgiving</span>
              <br />
              Cards with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Cozy Autumn Gratitude", desc: "Warm tones + subtle leaf texture." },
              { title: "Family Table Thanks", desc: "Clean premium layout for family moments." },
              { title: "Rustic Harvest Frame", desc: "Harvest vibe with elegant border." },
            ].map((t) => (
              <div
                key={t.title}
