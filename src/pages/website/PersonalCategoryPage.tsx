...
const personalTemplates = [
  {
    ...
    icon: UserRound,
    path: "/funnel/uploadPhoto?category=personal&type=name",
  },
  {
    id: "kids",
    title: "Kids",
    ...
    icon: Smile,
    path: "/funnel/uploadPhoto?category=personal&type=kids",
  },
  {
    id: "love",
    title: "Love",
    ...
    icon: Heart,
    path: "/funnel/uploadPhoto?category=personal&type=love",
  },
  {
    id: "apology",
    title: "Apology",
