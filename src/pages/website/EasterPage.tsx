// ✅ 1) Create: src/pages/website/EasterPage.tsx
...
export default function EasterPage() {
  ...
  // ✅ force occasion=easter (keep other params)
  next.set("occasion", "easter");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create Beautiful <span className="text-orange-300">Easter</span>
              <br />
              Cards with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Pastel Egg Frame", desc: "Soft pastel eggs + gentle glow." },
              { title: "Spring Floral Card", desc: "Fresh florals with premium spacing." },
              { title: "Cute Bunny Portrait", desc: "Playful spring vibe, modern layout." },
            ].map((t) => (
              <div
                key={t.title}
