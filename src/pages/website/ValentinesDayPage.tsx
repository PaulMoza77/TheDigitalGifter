// ✅ 1) Create: src/pages/website/ValentinesDayPage.tsx
...
export default function ValentinesDayPage() {
  ...
  // ✅ force occasion=valentines_day (keep other params)
  next.set("occasion", "valentines_day");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/80">
              ❤️ Valentine’s Day — Love & romance
            </div>

            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create a Romantic <span className="text-orange-300">Valentine’s</span>
              <br />
              Card with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Minimal Love Note", desc: "Clean typography + modern romance." },
              { title: "Rose Gold Couple Frame", desc: "Elegant glow + premium feel." },
              { title: "Heart Collage Card", desc: "Cute collage layout for couples." },
            ].map((t) => (
              <div
                key={t.title}
