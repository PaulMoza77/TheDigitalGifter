// ✅ 1) Create: src/pages/website/MothersDayPage.tsx
...
export default function MothersDayPage() {
  ...
  // ✅ force occasion=mothers_day (keep other params)
  next.set("occasion", "mothers_day");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/80">
              💐 Mother’s Day — Celebrate her
            </div>

            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create a Heartfelt <span className="text-orange-300">Mother’s Day</span>
              <br />
              Card with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Minimal Mom Portrait", desc: "Elegant typography + premium spacing." },
              { title: "Soft Floral Frame", desc: "Fresh florals with gentle glow." },
              { title: "Modern Photo Collage", desc: "Gallery-style layout for memories." },
            ].map((t) => (
              <div
                key={t.title}
