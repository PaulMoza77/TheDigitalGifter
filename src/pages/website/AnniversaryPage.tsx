// ✅ 1) Create: src/pages/website/AnniversaryPage.tsx
...
export default function AnniversaryPage() {
  ...
  // ✅ force occasion=anniversary (keep other params)
  next.set("occasion", "anniversary");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create a Timeless <span className="text-orange-300">Anniversary</span>
              <br />
              Card with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Minimal Couple Portrait", desc: "Elegant typography + clean spacing." },
              { title: "Golden Years Frame", desc: "Luxury gold accents + premium look." },
              { title: "Modern Photo Thank You", desc: "Gallery-style layout for milestones." },
            ].map((t) => (
              <div
                key={t.title}
