// ✅ 1) Create: src/pages/website/PregnancyPage.tsx
...
export default function PregnancyPage() {
  ...
  // ✅ force occasion=pregnancy (keep other params)
  next.set("occasion", "pregnancy");
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 md:p-10">
          ...
          <div className="relative">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/80">
              🤰 Pregnancy — Share the journey
            </div>

            <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-6xl">
              Create a Beautiful <span className="text-orange-300">Pregnancy</span>
              <br />
              Announcement with AI
            </h1>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { title: "Minimal Pregnancy Reveal", desc: "Clean, elegant typography and spacing." },
              { title: "Soft Pastel Journey", desc: "Warm pastel tones with gentle glow." },
              { title: "Baby Shoes Announcement", desc: "Cute icon frame + modern layout." },
            ].map((t) => (
              <div
                key={t.title}
