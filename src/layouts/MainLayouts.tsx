...
export default function MainLayout() {
  ...
  return (
    <>
      ...
      />
      {/* FOOTER */}
      <footer className="mt-16 border-t border-white/10 bg-gradient-to-b from-[#060a12] to-[#0a0e18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-[#c1c8d8] text-sm leading-relaxed mt-3">
                Create stunning AI-powered holiday cards with personalized
                magic. Spreading Christmas joy with cutting-edge technology.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
            ...
            <div className="flex items-center gap-1 text-[#8892a8] text-xs">
              <span>Made with</span>
              <Heart size={14} className="text-red-500 mx-0.5" />
