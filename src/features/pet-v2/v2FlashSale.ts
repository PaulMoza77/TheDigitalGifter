...
/** Rolling 24-hour urgency window — resets every cycle; checkout price stays $8. */
export const PET_V2_SALE_CYCLE_MS = 24 * 60 * 60 * 1000;

/** First cycle anchor (V2 dog funnel $8 rolling offer). */
...
/** Always $8 from $27 — timer rolls every 24h for urgency. */
