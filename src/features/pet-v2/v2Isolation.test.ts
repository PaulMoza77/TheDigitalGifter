...
describe("pet funnel V2 isolation", () => {
  ...
  it("cannot write V2 events into the V1 allow-list", () => {
    ...
    expect(readSrc("server/routes.mjs")).toContain("apple-developer-merchantid-domain-association");
  });
  ...
  it("uses existing mini clips and the other-pets animals already in the product", () => {
    ...
    expect(strip).toContain("v2.landing.livesH2");
    expect(strip).toContain("v2.landing.livesLede");
    ...
    expect(strip).toContain("other.${id}");
    expect(readSrc("src/features/pet-v2/screens/LandingScreen.tsx")).toContain("V2HeroProof");
    expect(readSrc("src/features/pet-v2/screens/LandingScreen.tsx")).toContain("V2ExampleStrip");
    expect(readSrc("src/features/pet-v2/V2PackOffer.tsx")).toContain("v2.pack.headlineRich");
    expect(readSrc("src/features/pet/i18n/copy/en.ts")).toContain("12 secret lives and 2 mini clips");
