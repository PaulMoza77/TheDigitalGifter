...
/** Percent positions over ChristmasTreeVisual (distinct from gifts-under-tree on /christmas/tree). */
export const GIFT_TREE_BOX_POSITIONS: Array<{ left: string; top: string }> = [
  { left: "32%", top: "26%" },
  { left: "58%", top: "30%" },
  { left: "22%", top: "42%" },
  { left: "48%", top: "40%" },
...
export function denyOpenCopy(code: string): string {
  switch (code) {
    ...
    case "no_rewards":
      return "The reward catalog is not live yet.";
    default:
