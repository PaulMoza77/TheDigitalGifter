...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    lede: "Create magical Christmas portraits for children — warm, private, and ready to share with family.",
    badge1: "Kids-safe & family friendly",
    badge2: "Your photos are private",
    badge3: "Magical results in minutes",
    cta: "Create Kid's Christmas Photos",
    ...
    step1Body: "Add a clear photo you have permission to use.",
    step2Title: "Choose a style",
    step2Body: "Pick a magical Christmas look for your child.",
    step3Title: "Generate with AI",
    step3Body: "Watch a private Christmas portrait come to life.",
    step4Title: "Download & share",
    step4Body: "Save the keepsake and share it with family.",
    finaleH2: "A gift they'll always remember",
    finaleLede: "A private Christmas portrait made with care — for the little ones who make the season glow.",
    finaleCta: "Create Kid's Christmas Photos",
