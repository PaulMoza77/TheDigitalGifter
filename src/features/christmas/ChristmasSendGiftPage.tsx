...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    badge1: "Private gift link",
    badge2: "Message in the URL fragment",
    badge3: "Ready in seconds",
    cta: "Compose your gift",
    ...
    step1Body: "Tree, portrait, Santa, or card — one magical experience.",
    step2Title: "Add your message",
    step2Body: "Write a short note that stays in the link fragment.",
    step3Title: "Create the link",
    step3Body: "Generate a private gift URL ready to share.",
    step4Title: "Send the surprise",
    step4Body: "Share or copy the link — they open the gift on their side.",
    finaleH2: "Make someone’s Christmas brighter",
    finaleLede: "A personal message and a magical experience — delivered as one private gift link.",
    finaleCta: "Start composing",
