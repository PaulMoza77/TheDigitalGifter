...
export const CHRISTMAS_FUNNEL_ALLOWED_EVENTS = [
  ...
  "gift_finder_interests_selected",
  "gift_finder_personality_selected",
  "gift_finder_budget_selected",
  "gift_finder_completed",
  "gift_finder_results_viewed",
  "gift_finder_failed",
  "gift_finder_result_saved",
  "gift_finder_result_clicked",
  ...
  // Interactive gift tree / chance funnel
  ...
  "christmas_checkout_started",
  "christmas_product_view",
  "christmas_purchase",
  "christmas_generation_started",
  "christmas_result_viewed",
  "christmas_upsell_view",
  "christmas_upsell_purchase",
  "christmas_bundle_purchase",
  "credits_pack_view",
  "credits_purchase_started",
  "credits_purchase_success",
  "credits_purchase_failed",
  "christmas_chance_pack_selected",
  ...
  "christmas_reward_redeem_start",
  "christmas_reward_redeemed",
  "my_gifts_view",
] as const;
