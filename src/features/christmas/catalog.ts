...
export const CHRISTMAS_CATALOG_SEED: ChristmasProductDef[] = [
  ...
  },
  {
    ...
    localeDefault: "en",
    metadata: { planner_v1: true, live_offer: true },
    packages: [
      {
        packageKey: "core",
        packageName: "Christmas Planner Core",
        ...
        sortOrder: 10,
        localeDefault: "en",
        metadata: { features: ["planner_core", "gift_planner", "budget", "advanced_planning", "rescue_mode"] },
      },
      {
        packageKey: "complete",
        packageName: "Christmas Planner Complete",
        description: "Core plus food, recipes, hosting, and travel.",
        currency: "eur",
        priceCents: 2499,
        compareAtCents: 3999,
        active: true,
