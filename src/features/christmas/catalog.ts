...
export const CHRISTMAS_CATALOG_SEED: ChristmasProductDef[] = [
  ...
  },
  {
    ...
    packages: [
      ...
      {
        packageKey: "magic",
        packageName: "Christmas Magic",
        description: "Essentials plus meals, hosting, cards, traditions, travel, Gift Finder, and Rescue Mode.",
        currency: "usd",
        priceCents: 2700,
        compareAtCents: null,
        active: true,
      ...
      },
      {
        ...
        features: [
          ...
          "Premium planning content",
          "Digital Gifter photo credit bonus",
          "Future AI Christmas Assistant access",
          "Premium Christmas Club content where applicable",
        ],
        sortOrder: 30,
        localeDefault: "en",
      ...
      },
      {
        ...
        packageName: "Christmas Recipes & Food Guide",
        description: "Standalone meals and recipe planning pack.",
        currency: "usd",
        priceCents: 900,
        compareAtCents: null,
        active: true,
        purchasable: true,
        features: ["Recipe collection", "Meal planner"],
        sortOrder: 40,
        localeDefault: "en",
        metadata: { kind: "addon" },
      },
      {
        packageKey: "addon_hosting",
        packageName: "Hosting Pack",
        description: "Standalone hosting planner pack.",
        currency: "usd",
        priceCents: 900,
        compareAtCents: null,
        active: true,
        purchasable: true,
        features: ["Hosting planner"],
        sortOrder: 50,
        localeDefault: "en",
        metadata: { kind: "addon" },
      },
      {
        packageKey: "addon_activities",
        packageName: "Christmas Activity Pack",
        description: "Standalone activities and traditions pack.",
        currency: "usd",
        priceCents: 900,
        compareAtCents: null,
        active: true,
        purchasable: true,
        features: ["Activities & traditions"],
        sortOrder: 60,
        localeDefault: "en",
        metadata: { kind: "addon" },
      },
      {
        packageKey: "addon_gift_ideas",
        packageName: "Gift Ideas Pack",
        description: "Standalone Gift Finder ideas pack.",
        currency: "usd",
        priceCents: 900,
        compareAtCents: null,
        active: true,
        purchasable: true,
        features: ["Advanced Gift Finder"],
        sortOrder: 70,
        localeDefault: "en",
        metadata: { kind: "addon" },
      },
      {
        packageKey: "addon_travel",
        packageName: "Christmas Travel / Places Inspiration",
        description: "Standalone travel planning pack.",
        currency: "usd",
        priceCents: 900,
        compareAtCents: null,
        active: true,
        purchasable: true,
        features: ["Travel planner"],
        sortOrder: 80,
        localeDefault: "en",
        metadata: { kind: "addon" },
      },
      {
        packageKey: "addon_photo_credits",
        packageName: "Digital Gifter Christmas photo credit pack",
        description: "Bonus Christmas photo credits entitlement.",
        currency: "usd",
        priceCents: 1500,
        compareAtCents: null,
        active: true,
        purchasable: true,
        features: ["Christmas photo credit bonus"],
        sortOrder: 90,
        localeDefault: "en",
        metadata: { kind: "addon" },
      },
  ...
  },
  {
    ...
    description: "Personal Christmas command center for gifts, budget, meals, and hosting.",
    active: true,
    publicDiscoverable: true,
    sortOrder: 8,
    routePath: "/christmas/planner",
    localeDefault: "en",
    metadata: { planner_v1: true, live_offer: false },
    packages: [
      {
        packageKey: "essentials",
        packageName: "Essentials",
        description: "Gifts, budget, dynamic plan, rescue mode.",
        currency: "eur",
        priceCents: 1499,
        compareAtCents: null,
        active: true,
        purchasable: false,
        features: ["planner_core", "gift_planner", "budget", "advanced_planning", "rescue_mode"],
        sortOrder: 10,
        localeDefault: "en",
        metadata: { tier: "paid_1" },
      },
      {
        packageKey: "magic",
        packageName: "Christmas Magic",
        description: "Essentials plus food, recipes, hosting, and travel.",
        currency: "eur",
        priceCents: 2499,
        compareAtCents: null,
        active: true,
        ...
        sortOrder: 20,
        localeDefault: "en",
        metadata: { tier: "paid_2", recommended: true },
      },
      {
        packageKey: "all_in",
        packageName: "All-in",
        description: "Highest commercial tier — same modules as Christmas Magic until extra packs ship.",
        currency: "eur",
        priceCents: 3499,
        compareAtCents: null,
        active: true,
