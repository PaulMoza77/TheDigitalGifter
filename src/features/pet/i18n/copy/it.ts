...
export const PET_COPY_IT: PetCopyMap = {
  ...
  "species.yourDog": "del tuo cane",
  "species.yourCat": "del tuo gatto",
  "species.yourPet": "del tuo animale",
  ...
  "v2.landing.lede": "Carica una foto e ricevi gratis un teaser sfocato della vita segreta {pet} — senza carta.",
  "v2.landing.lede.dog": "Carica una foto e ricevi gratis un teaser sfocato della vita segreta del tuo cane — senza carta.",
  "v2.landing.lede.cat": "Carica una foto e ricevi gratis un teaser sfocato della vita segreta del tuo gatto — senza carta.",
  "v2.landing.lede.other": "Carica una foto e ricevi gratis un teaser sfocato della vita segreta del tuo animale — senza carta.",
  ...
  "v2.landing.closingRenew": "{price} · l’offerta si rinnova ogni 24 ore",
  "v2.landing.saleLine": "{price} oggi · restano {countdown}",
  "v2.landing.stickySale": "{price} oggi · restano {countdown}",
  ...
  "v2.teaser.h1.dog": "La vita segreta del tuo cane è pronta per essere svelata.",
  "v2.teaser.h1.cat": "La vita segreta del tuo gatto è pronta per essere svelata.",
  "v2.teaser.h1.other": "La vita segreta del tuo animale è pronta per essere svelata.",
