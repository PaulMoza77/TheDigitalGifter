...
export const PET_COPY_NL: PetCopyMap = {
  ...
  "species.yourDog": "van je hond",
  "species.yourCat": "van je kat",
  "species.yourPet": "van je huisdier",
  ...
  "v2.teaser.h1.dog": "Het geheime leven van je hond is klaar om onthuld te worden.",
  "v2.teaser.h1.cat": "Het geheime leven van je kat is klaar om onthuld te worden.",
  "v2.teaser.h1.other": "Het geheime leven van je huisdier is klaar om onthuld te worden.",
