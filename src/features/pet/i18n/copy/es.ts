...
export const PET_COPY_ES: PetCopyMap = {
  ...
  "species.yourDog": "de tu perro",
  "species.yourCat": "de tu gato",
  "species.yourPet": "de tu mascota",
  ...
  "v2.landing.lede": "Sube una foto y recibe gratis un avance borroso de la vida secreta {pet} — sin tarjeta.",
  "v2.landing.lede.dog": "Sube una foto y recibe gratis un avance borroso de la vida secreta de tu perro — sin tarjeta.",
  "v2.landing.lede.cat": "Sube una foto y recibe gratis un avance borroso de la vida secreta de tu gato — sin tarjeta.",
  "v2.landing.lede.other": "Sube una foto y recibe gratis un avance borroso de la vida secreta de tu mascota — sin tarjeta.",
  ...
  "v2.landing.closingRenew": "{price} · la oferta se renueva cada 24 horas",
  "v2.landing.saleLine": "{price} hoy · quedan {countdown}",
  "v2.landing.stickySale": "{price} hoy · quedan {countdown}",
  ...
  "v2.teaser.h1.dog": "La vida secreta de tu perro está lista para revelarse.",
  "v2.teaser.h1.cat": "La vida secreta de tu gato está lista para revelarse.",
  "v2.teaser.h1.other": "La vida secreta de tu mascota está lista para revelarse.",
