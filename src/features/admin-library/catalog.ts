...
const CHRISTMAS_REELS: LibraryVideo[] = [
  {
    ...
    description:
      "31.9s 1080×1920. Buyer-persona story: love Christmas → overwhelm → discovery → relief. Voiceover + captions + original music. Open My Christmas Planner CTA. Tags: christmas, planner, lauren, ready-to-post.",
    ...
    width: 1080,
    height: 1920,
    fileSizeBytes: 23597874,
    createdAt: "2026-09-21T17:58:00Z",
    tags: [...CINEMATIC_REEL_TAGS, "planner", "lauren", "voiceover", "captions"],
  ...
  },
  {
    ...
    description:
      "31.9s 1080×1920. Same story with voiceover and music, no captions. Narration: public/assets/christmas/lauren-overwhelm/audio/vo_lauren_overwhelm_full.wav",
    ...
    width: 1080,
    height: 1920,
    fileSizeBytes: 22745445,
    createdAt: "2026-09-21T17:58:00Z",
    tags: [...CINEMATIC_REEL_TAGS, "planner", "lauren", "voiceover", "no-captions"],
    model: "kling-video/v3.0/pro/image-to-video",
    costUsd: 1.76,
    clipsUsed: [
      "short-lauren-01-intro",
