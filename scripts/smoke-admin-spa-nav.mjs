...
const adminRouteSkipsVerify =
  /already verified/.test(adminRoute) && /ready && prev\.email === nextEmail/.test(adminRoute);
  ...
  JSON.stringify(
    {
      ...
      admin_route_skips_verify: adminRouteSkipsVerify,
    },
    null,
    2,
  ),
