import { optionsResponse, jsonResponse, privateJsonResponse } from "../_shared/cors.ts";
 ...
 * Privacy: getOrder returns a safe projection only (no metadata / plaintext tokens).
 */
