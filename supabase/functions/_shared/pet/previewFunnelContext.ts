...
export const PET_PREVIEW_IDENTITY_BUILD = "pet-preview-identity-2026-08-28g";
...
export const F1_DRIVER_EDIT =
  "SCENE REQUIREMENT (mandatory): photoreal Formula 1 style racing edit — the uploaded pet MUST be alone in a realistic open-wheel race car cockpit on a bright sunlit racetrack or pit lane. Do NOT output a plain studio portrait, indoor floor photo, or unchanged background. Keep the pet’s real head/face/mane identity from the reference (environment/wardrobe edit, not a breed redesign). Head bare: HARD BAN closed/full-face helmet covering ears or cheek ruff; optional tiny goggles/scarf only above the forehead so the full mane stays visible. If the reference has a dense Chow Chow–style mane, show that full mane volume in the cockpit. Vivid racing colors allowed without real commercial logos/team marks (no Red Bull, Ferrari, Mercedes, Pirelli, or readable brand text). Pet is the sole focal point. No human driver, passenger, hands, or helmeted person. Avoid muddy grading, cartoons, goofy costumes, clutter, and distorted anatomy.";
