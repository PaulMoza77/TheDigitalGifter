-- Fix activate_christmas_send_a_gift share token generation.
-- Production has pgcrypto in schema "extensions" (see 20260816160000_pet_funnel).
-- Bare gen_random_bytes() failed at runtime with 42883.
-- Superseded functionally by 20260906030000 (also renames ambiguous vars); kept for version history.
begin;
