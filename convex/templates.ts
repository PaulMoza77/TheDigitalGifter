    ...
    const items: TemplateSeed[] = [
      {
        ...
        type: "video",
        orientation: "landscape",
        previewUrl: "https://example.com/preview_cinematic.mp4",
        prompt:
        ...
        creditCost: 40,
        tags: ["video", "cinematic", "trailer"],
        scene: "promo",
        textDefault: "A cinematic holiday trailer",
        // video-specific fields stored in template for admin use; kept server-side
        defaultDuration: 8,
      ...
      {
        title: "Social Media Vertical Ad",
        category: "Modern",
        subCategory: "Ad",
        type: "video",
        orientation: "portrait",
        previewUrl: "https://example.com/preview_vertical.mp4",
        prompt:
          "CRITICAL: Preserve any uploaded faces unchanged. Produce a punchy vertical ad (9:16) with quick cuts, upbeat tempo, and bold text overlays. Optimize for social platforms.",
        creditCost: 24,
        tags: ["video", "vertical", "social"],
        scene: "ad",
        textDefault: "Your moment, amplified",
        defaultDuration: 6,
      ...
      },
      {
        ...
        type: "video",
        orientation: "portrait",
        previewUrl: "https://example.com/preview_greeting.mp4",
        prompt:
          "CRITICAL: Preserve any uploaded faces unchanged. Create a warm animated greeting with gentle motion, falling snow, and soft piano music. Keep it short and loop-friendly.",
        creditCost: 18,
        tags: ["video", "greeting", "animated"],
        scene: "card",
        textDefault: "Happy Holidays!",
        defaultDuration: 4,
        defaultAspectRatio: "9:16",
        defaultResolution: "720p",
