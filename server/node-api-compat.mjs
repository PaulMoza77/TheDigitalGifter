/**
 * Minimal Node (req, res) adapter for the Mozas VPS origin.
 * Decorates IncomingMessage/ServerResponse so /api handlers can use
 * status/json/send and parsed JSON bodies.
...
export async function invokeNodeHandler(handler, req, res, url) {
