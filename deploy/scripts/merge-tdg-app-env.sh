...
merge_key OPENAI_API_KEY "${OPENAI_API_KEY:-}"
merge_key CLIP_FACTORY_CRON_SECRET "${CLIP_FACTORY_CRON_SECRET:-}"
merge_key CLIP_FACTORY_IMPORT_WORKER_TOKEN "${CLIP_FACTORY_IMPORT_WORKER_TOKEN:-}"
merge_key CLIP_FACTORY_SIGNING_SECRET "${CLIP_FACTORY_SIGNING_SECRET:-}"
merge_key YOUTUBE_API_KEY "${YOUTUBE_API_KEY:-}"
merge_key CLIP_FACTORY_YOUTUBE_IMPORT_URL "${CLIP_FACTORY_YOUTUBE_IMPORT_URL:-}"
merge_key CLIP_FACTORY_YOUTUBE_IMPORT_SECRET "${CLIP_FACTORY_YOUTUBE_IMPORT_SECRET:-}"
merge_key CLIP_INGEST_PROVIDER "${CLIP_INGEST_PROVIDER:-}"
merge_key CLIP_INGEST_ENDPOINT "${CLIP_INGEST_ENDPOINT:-}"
merge_key CLIP_INGEST_API_KEY "${CLIP_INGEST_API_KEY:-}"
merge_key CLIP_INGEST_FALLBACK_PROVIDER "${CLIP_INGEST_FALLBACK_PROVIDER:-}"
merge_key VIMEO_ACCESS_TOKEN "${VIMEO_ACCESS_TOKEN:-}"
merge_key META_APP_ID "${META_APP_ID:-}"
merge_key META_APP_SECRET "${META_APP_SECRET:-}"
merge_key META_CONFIGURATION_ID "${META_CONFIGURATION_ID:-}"
merge_key META_OAUTH_REDIRECT_URL "${META_OAUTH_REDIRECT_URL:-}"
merge_key SOCIAL_PUBLISHER_PUBLIC_BASE_URL "${SOCIAL_PUBLISHER_PUBLIC_BASE_URL:-}"
merge_key SOCIAL_TOKEN_ENCRYPTION_KEY "${SOCIAL_TOKEN_ENCRYPTION_KEY:-}"
merge_key SOCIAL_OAUTH_REDIRECT_URL "${SOCIAL_OAUTH_REDIRECT_URL:-}"
merge_key YOUTUBE_CLIENT_ID "${YOUTUBE_CLIENT_ID:-}"
merge_key YOUTUBE_CLIENT_SECRET "${YOUTUBE_CLIENT_SECRET:-}"
merge_key YOUTUBE_REDIRECT_URI "${YOUTUBE_REDIRECT_URI:-}"
merge_key YOUTUBE_LIVE_MAX_CONCURRENT "${YOUTUBE_LIVE_MAX_CONCURRENT:-1}"
